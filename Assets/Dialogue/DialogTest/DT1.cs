...
public class DT1 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        dialogTexts.Add(new DialogData("/size:up/Hi, /size:init/its yaboi Nero.", "Nero"));

        dialogTexts.Add(new DialogData("I am Pitung. Popped out to let you know Asset can show other characters.", "Pitung"));
        
        dialogTexts.Add(new DialogData("This Asset, The D'Dialog System has many features.", "Nero"));
